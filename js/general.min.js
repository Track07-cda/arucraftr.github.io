...
$(function(a){a("body, html");var b=a("html"),c=a("body"),e=a("#preloader"),d=e.find(".loader"),h=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);b.addClass(h?"mobile":"no-mobile");window.sr=ScrollReveal();a(".reveal").each(function(){var f=a(this),g={easing:"cubic-bezier(.51, .07, .75, .95)",mobile:!1,scale:1.01},k=f.data("reveal-container"),l=f.data("reveal-origin"),m=f.data("reveal-distance"),n=f.data("reveal-duration"),p=f.data("reveal-delay"),q=f.data("reveal-easing"),
r=f.data("reveal-scale"),t=f.data("reveal-opacity"),u=f.data("reveal-reset");"undefined"!==typeof k&&(g.container=k);"undefined"!==typeof l&&(g.origin=l);"undefined"!==typeof m&&(g.distance=m);"undefined"!==typeof n&&(g.duration=n);"undefined"!==typeof p&&(g.delay=p);"undefined"!==typeof q&&(g.easing=q);"undefined"!==typeof r&&(g.scale=r);"undefined"!==typeof t&&(g.opacity=t);"undefined"!==typeof u&&(g.reset=!0);sr.reveal(f,g)});a(".demo-button-load-more-comments").on("click",function(){var f=a(this).button("loading");
setTimeout(function(){f.button("reset")},1500)});a(window).on("load",function(){d.delay(500).fadeOut();e.delay(1500).fadeOut("slow");setTimeout(function(){c.addClass("loaded")},1E3)})});
